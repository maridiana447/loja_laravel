...
<div class="container container-sm">
    ...
    <h3 class="text-center">Visualizar Encomenda</h3>
    <div class="row mt-2 justify-content-center p-3 rounded shadow-sm bg-body-tertiary">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
            <button class="btn btn-warning btn-sm" id="btn_alterar">Alterar Encomenda</button>
            <button class="btn btn-danger btn-sm ms-2" id="btn_excluir">Excluir Encomenda</button> 
        </div>
