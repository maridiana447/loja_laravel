...
<body style="background-image:url(pink.webp); background-size: cover;">
    ...
    <div class="container mt-4" style="background-color:  rgb(37, 6, 37);">
        <div class="row">
            <div class="col-md-4">
                <img src="pirulito2.webp" class="img-fluid rounded shadow-sm" style="margin-top: 50px;" alt="">
            </div>
            <div class="col-md-8">
                ...
                <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
                    ...
                    <p>O Bruxolito Abóbora é o doce perfeito, com formato de abóbora e cores vibrantes, ele é perfeito
                        para lembrancinhas e decorações. <br>
