...
<body style="background-image:url(pink.jpg); background-size: cover;">
    ...
    <div class="container mt-4" style="background-color:  rgb(37, 6, 37);">
        <div class="row">
            <div class="col-md-4">
                <img src="pirulito.png" class="img-fluid rounded shadow-sm" style="margin-top: 50px;" alt="Sua Imagem">
            </div>
            <div class="col-md-8">
                ...
                <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
                    ...
                    <p>O Bruxolito é o produto mais assustador de nossa loja, logo ele é o mais vendido. <br>
