...
<body style="background-image:url(pink.jpg); background-size: cover;">
    ...
    <div class="container mt-4" style="background-color:  rgb(37, 6, 37);">
        <div class="row">
            <div class="col-md-4">
                <img src="chocolate2.png" img-fluid rounded shadow-sm" style="margin-top: 30px;" alt="Sua Imagem">
            </div>
            <div class="col-md-8">
                ...
                <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
                    ...
                    <p>O nosso chocolate caixão traz um sabor especial com variedades de chocolate e uma experiência
                        incrível! <br>
